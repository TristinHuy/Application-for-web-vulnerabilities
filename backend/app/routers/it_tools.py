...
def network_ping(payload: PingRequest):
    ...
    The endpoint accepts user input directly in a shell command without validation.
    This allows attackers to inject arbitrary shell operators like &&, |, ;, etc.
    ...
    - 8.8.8.8 | id
    """
    # NO VALIDATION - Directly use user input in shell command
    try:
